      ...
      <Container>
        <Grid container spacing={3}>
          ...
          <Grid item xs={12} md={7}>
            ...
            Establece la forma de aprendizaje según tus deseos con algunas de las ventajas que te ofrecemos, para que puedas
              disfrutes de las lecciones que te proporcionamos.
            </Typography>
